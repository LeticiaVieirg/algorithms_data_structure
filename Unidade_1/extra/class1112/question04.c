...
//typede= renomear ou criar novos tipos
...
typedef struct student Student; // renomeou o novo tipo Student que nao existe na linguagem c

void preenche(Student* student){
	printf("enter a name: \n");
	scanf(" %[^\n]", student->name);
